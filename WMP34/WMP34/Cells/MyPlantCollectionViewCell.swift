...
class MyPlantCollectionViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        vertStack.addArrangedSubview(speciesLabel)
    ...
    var titleLabel:UILabel = {
        let ccgRect = CGRect(x:100, y: 20, width: 100 , height: 30)
    ...
    var speciesLabel: UILabel = {
        let ccgRect = CGRect(x: 100, y: 20, width: 100, height: 20)
        let label = UILabel(frame: ccgRect)
        label.textColor = UIColor.black
        
        guard let customFont = UIFont(name: "AppleSDGothicNeo-SemiBold", size: 15) else {
            fatalError("No font"
            )
        }
    ...
    private func updateViews() {
        ...
        case "5":
            wetOne.image = UIImage(named: "fullDrop-2")
            wetTwo.image = UIImage(named: "fullDrop-2")
            wetThree.image = UIImage(named: "fullDrop-2")
            wetFour.image = UIImage(named: "fullDrop-2")
            wetFive.image = UIImage(named: "fullDrop-2")
        case "86400":
            wetOne.image = UIImage(named: "fullDrop-2")
            wetTwo.image = UIImage(named: "fullDrop-2")
            wetThree.image = UIImage(named: "fullDrop-2")
            wetFour.image = UIImage(named: "fullDrop-2")
            wetFive.image = UIImage(named: "emptyDrop-2")
        case "172800":
            wetOne.image = UIImage(named: "fullDrop-2")
            wetTwo.image = UIImage(named: "fullDrop-2")
            wetThree.image = UIImage(named: "fullDrop-2")
            wetFour.image = UIImage(named: "emptyDrop-2")
            wetFive.image = UIImage(named: "emptyDrop-2")
        case "259200":
            wetOne.image = UIImage(named: "fullDrop-2")
            wetTwo.image = UIImage(named: "fullDrop-2")
            wetThree.image = UIImage(named: "emptyDrop-2")
            wetFour.image = UIImage(named: "emptyDrop-2")
            wetFive.image = UIImage(named: "emptyDrop-2")
        case "604800":
            wetOne.image = UIImage(named: "fullDrop-2")
            wetTwo.image = UIImage(named: "emptyDrop-2")
            wetThree.image = UIImage(named: "emptyDrop-2")
            wetFour.image = UIImage(named: "emptyDrop-2")
            wetFive.image = UIImage(named: "emptyDrop-2")
        default:
            wetOne.image = UIImage(named: "emptyDrop-2")
            wetTwo.image = UIImage(named: "emptyDrop-2")
            wetThree.image = UIImage(named: "emptyDrop-2")
            wetFour.image = UIImage(named: "emptyDrop-2")
            wetFive.image = UIImage(named: "emptyDrop-2")
